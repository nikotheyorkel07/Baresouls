  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'lavender-gradient': 'linear-gradient(135deg, #a855f7 0%, #ec4899 100%)',
        'ocean-gradient': 'linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%)',
        'sunset-gradient': 'linear-gradient(135deg, #f97316 0%, #ef4444 100%)',
        'forest-gradient': 'linear-gradient(135deg, #22c55e 0%, #10b981 100%)',
        'moonlight-gradient': 'linear-gradient(135deg, #64748b 0%, #475569 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
